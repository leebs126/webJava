...
CONSTRAINT FK_RES_USER_ID FOREIGN KEY(resUserId) REFERENCES t_Member2 (memId),
CONSTRAINT FK_RES_CAR_NUMBER FOREIGN KEY(resCarNumber) REFERENCES t_Car2 (CarNumber)
);
