...
public class CarMenu {
	...
	public void doCarMenu() throws CarException{
	...
	private void menuCarList() throws CarException{
		carList = car.listCarInfo();         			//렌터카 리스트 출력하기
		((AbstractBase)car).displayData(carList);
	}
	
	private void menuCarView() throws CarException{
		Scanner sc = new Scanner(System.in);
	...
	private void menuCarReg() throws CarException{
		Scanner sc = new Scanner(System.in);
	...
	private void menuCarMod() throws CarException{
		menuCarList();
	...
	private void menuCarDel() throws CarException{
		menuCarList();
		Scanner sc = new Scanner(System.in);
