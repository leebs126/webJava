...
public class MemberImpl extends AbstractBase implements Member {
	...
	public MemberImpl() throws MemberException, IOException {
		memberFile = new File("src\\com\\oracle\\rent\\ch22\\member\\memberData.txt");
	...
	public void regMember(MemberVO memberVO) throws MemberException, IOException{
		String memData = null;
		OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(memberFile, true), "UTF-8");
		BufferedWriter bw = new BufferedWriter(osw);
		printer = new PrintWriter(bw,true);
