...
//					return 0;
		...
		treeSet1.add(new Student("차범근", 1, 80));
		treeSet1.add(new Student("손흥민", 2, 80));
		treeSet1.add(new Student("유현진", 4, 94));
...
//					return 0;
		...
		treeSet2.add(new Student("홍길동", 3, 90));
		treeSet2.add(new Student("차범근", 2, 70));
		treeSet2.add(new Student("손흥민", 2, 80));
		treeSet2.add(new Student("유현진", 3, 94));
